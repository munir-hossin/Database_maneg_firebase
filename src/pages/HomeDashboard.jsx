...
import {deleteCategories, getCategories} from "../fetures/categories/categoriesSlice"
...
export default function HomeDashboard() {
 ...
 const [deleteCategoryId, setDeleteCategoryId] = useState(false);
                ...
                >
                    ...
                    />
                     ...
                     <div className="flex justify-between mt-4">
                            ...
                            <button onClick={() => handleClick(category.id)} className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600">
                                Delete
                            </button>
                       </div>
    ...
    return (
        <div>
            {deleteCategoryId && <Modal onDelete={handleDelete} onClose={handleModalClose} />}
